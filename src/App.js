    ...
    <div className="container max-w-[1440px] w-full m-auto flex justify-between mb-8 bg-white mt-8 pl-[10px] pr-[10px] max-xl:flex-col ">
      ...
      <div className="mt-[242px] max-xl:absolute ml-[5px] mt-[50px] max-sm:mt-[10px]">
        <div>
          ...
          <h1 className="text-3xl font-bold mb-6 max-xl:text-white max-sm:mb-[0px]">
            Login to your account
          </h1>
          <p className="text-black opacity-80 font-normal mb-3 max-xl:text-white max-sm:mb-[0px]">
            Email
          </p>
          <input
            className="rounded-md box-border border-2 pl-[20px] pt-4 pb-4 w-[347px]  placeholder:text-slate-400 block bg-white max-sm:mb-[0px] w-[300px] pt-2 pb-2"
            type="email"
            placeholder="John.snow@gmail.com"
          />
          <p className="text-black opacity-80 font-normal mb-3 mt-3 max-xl:text-white max-sm:mb-[0px]">
            Password
          </p>
          <input
            className="rounded-md box-border border-2 pl-[20px] pt-4 pb-4 w-[347px] placeholder:text-slate-400 block bg-white max-sm:mb-[0px] w-[300px] pt-2 pb-2"
          ...
          <button
            className="bg-green-500 block w-[347px] rounded-md pt-5 pb-5 font-bold text-white text-base hover:text-black mb-3.5 w-[300px] pt-2 pb-2"
            type="submit"
          >
            Login now
          </button>
          <button
            className="mb-[142px] justify-center bg-slate-800 flex items-center block w-[347px] rounded-md pt-5 pb-5 font-bold text-white text-base   max-xl:mb-[50px]  max-sm:mb-[10px] w-[300px] pt-2 pb-2"
            type="submit"
          >
            <img
              className="mr-2"
